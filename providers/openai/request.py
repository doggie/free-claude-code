"""Request builder for generic OpenAI-compatible chat completions.

Converts an Anthropic Messages request into standard OpenAI
...
def _normalize_max_completion_tokens(body: dict[str, Any]) -> None:
    """Prefer ``max_completion_tokens``; fall back to ``max_tokens``."""
